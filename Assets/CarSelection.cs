...
public class CarSelection : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        r32Button.onClick.AddListener(delegate { Debug.Log("r32"); goToTrackSelection();  });
        roadsterButton.onClick.AddListener(delegate { Debug.Log("Leaderboard"); goToTrackSelection(); });
